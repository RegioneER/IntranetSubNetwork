 ...
 */
class GetIntranetSubnetworkReport extends Base
{
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('IntranetSubNetwork_WidgetIntranetSubNetwork');
        $this->dimension     = Piwik::translate('IntranetSubNetwork_ColumnIntranetSubNetwork');
        $this->dimension     = null;
        $this->documentation = Piwik::translate('IntranetSubNetwork_WidgetIntranetSubNetworkDocumentation');
        $this->order = 51;
    ...
    public function configureView(ViewDataTable $view)
    {
        if (!empty($this->dimension)) {
            $view->config->addTranslations(array('location_subnetwork' => $this->dimension->getName()));
        }
        ...
        $view->config->columns_to_display = array_merge(array('location_subnetwork'), $this->metrics);
    }
    ...
    {
        $view = new View('@IntranetSubNetwork/getIntranetSubnetworkReport');
        $view->myData = array();
